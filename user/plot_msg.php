				...
				<div class="col-lg-12 col-md-12">
					<div class="cart-table-wrap">
                                            <?php
                                                        ...
                                                        $sel_gal=mysqli_query($dbcon,"select * from plot_msg where oid='$usr'");
						...
						<table class="cart-table">
							<thead class="cart-table-head">
								<tr class="table-head-row">
									...
									<th class="product-name">Plot</th>
									<th class="product-price">Area</th>
							...
							<tbody>
                                                            ...
                                                            {
                                                                $sel=mysqli_query($dbcon,"select * from plot where id='$r_gal[1]'");
    $r=mysqli_fetch_row($sel);
                                                                $i++;
                                                                ?>
								<tr class="table-body-row">
									<td class="product-remove"><?php echo $i ?></td>
                                                                        <td class="product-name"><?php echo $r[1] ?></td>
									<td class="product-price"><?php echo $r[2] ?> </td>
								...
								<td class="product-quantity"><?php echo $r_gal[8] ?></td>
                                                                </tr>
