...
?>
                    ...
                    if(isset($_POST['b1']))
 {
    ...
    $ins=mysqli_query($dbcon,"insert into wet values('','$t1','$t2','0')");
    
    if($ins>0)
    {
     
                header("location:add_wet.php?suss=1");
            }
    }
...
<?php
                            if(isset($_GET['del']))
{
    $del1=mysqli_query($dbcon,"delete from wet where id='".$_GET['del']."'");
    //echo mysql_error();
    if($del1>0)
    {
       header("location:add_wet.php");
}
}
			...
			<div class="row">
					...
					<div class="contact-form">
						<form method="POST" id="fruitkha-contact" >
                                                           ...
                                                           Enter month
                                                            <br/>
                                                            <input type="month"  name="t1" style="width: 100%" >
							</p>  
                                                        ...
                                                        <div class="col-lg-12">
                                                          ...
                                                          Enter Crops
                                                            <br/>
                                                            <input type="text" placeholder="Crops" name="t2" style="width: 100%" >
							</p>  
                            ...
                            <div class="col-lg-6 mb-5 mb-lg-0">
                                     ...
                                     <?php
                                                        ...
                                                        $sel_gal=mysqli_query($dbcon,"select * from wet order by id desc");
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="add_wet.php?del=<?php echo $r_gal[0] ?>"><span style="color: red" class="fa fa-trash"></span></a></td>
