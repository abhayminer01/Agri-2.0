...
<body>
	...
	<!-- contact form -->
        ...
        <a class="weatherwidget-io" href="https://forecast7.com/en/8d5276d94/thiruvananthapuram/" data-label_1="WEATHER" data-label_2="DETAILS" data-theme="original" >TRIVANDRUM WEATHER</a>
        <script>
 ...
 {
                        $t1=$_POST['t1'];
                                                        $sel_gal=mysqli_query($dbcon,"select * from wet where mth='$t1'");
 ...
 else
 {
                    ...
                    <div class="row">
            <center><h3 style="text-align: center;">search weather</h3></center>
            <iframe src="05/index.html" style="width: 100%; height: 1200px;"></iframe>
        </div>
