...
<body>
				...
				<div class="col-lg-12 col-md-12">
					<div class="cart-table-wrap">
                                            <?php
                                                        ...
                                                        $sel_gal=mysqli_query($dbcon,"select * from sale where uid='$usr'");
						...
						<table class="cart-table">
							<thead class="cart-table-head">
								<tr class="table-head-row">
									...
									<th class="product-total">Farmer</th>
    ...
    $sel1=mysqli_query($dbcon,"select * from user_data where em='$r_gal[8]'");
    $r1=mysqli_fetch_row($sel1);
								...
								<tr class="table-body-row">
									...
									<td class="product-total"><b><?php
                                                                        ...
                                                                        ?> Rs/-</b></td>
                                                                        <td class="product-quantity"><?php echo $r1[1] ?></td>
                                                                        <td class="product-quantity"><a  href="tel:<?php echo $r1[2] ?>"><?php echo $r1[2] ?></a></td>
                                                                        
                                                                        <td class="product-quantity"><?php echo $r1[5] ?></td>
								<td class="product-quantity"><?php echo $r_gal[9] ?></td>
                                                                <td class="product-quantity"><?php echo $r_gal[10] ?></td>
                                                                <td class="product-quantity"><a target="_blank" href="qrcode.php?mid=<?php echo $r_gal[0] ?>&tot=<?php echo $tot ?>"><span class="fa fa-qrcode"></span></a></td>
                                                                </tr>
