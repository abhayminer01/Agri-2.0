                    ...
                    if(isset($_POST['b1']))
 {
   ...
   $t2=$_POST['t2'];
    ...
    $t5=$_POST['t5'];
       ...
       $log1=mysqli_query($dbcon,"select * from user_log where uid='$t4'");
...
else
{
    ...
    $ins=mysqli_query($dbcon,"insert into dis_data values('','$t1','$t2','$t3','$t4','$t5','0')");
    
    if($ins>0)
    {
      $ins1=mysqli_query($dbcon,"insert into user_log values('','$t4','$t5','office','0')");
        if($ins1>0)
        {
			...
			<div class="row">
					...
					<div class="contact-form">
						<form method="POST" id="fruitkha-contact" 
							...
							<p>
								<input type="text" placeholder="Office Name" name="t2" >
								<input type="tel" placeholder="Phone" name="t3"  required="" onkeyup="chkc(this.value)" /><span id="o3"></span>
							</p>
							<p>
								
                                                                <input type="email" placeholder="Email" name="t4" required=""onkeyup="vem(this.value)" /><span id="em"></span>
								<input type="password" placeholder="*******" name="t5" >
							</p>
                            ...
                            <div class="col-lg-6 mb-5 mb-lg-0">
                                     ...
                                     <?php
                                                        ...
                                                        $sel_gal=mysqli_query($dbcon,"select * from dis_data");
