...
?>
                    ...
                    if(isset($_POST['b1']))
 {
    ...
    $ins=mysqli_query($dbcon,"insert into cate values('','$t1','0')");
    
    if($ins>0)
    {
     
                header("location:add_cate.php?suss=1");
            }
    }
			...
			<div class="row">
					...
					<div class="contact-form">
						<form method="POST" id="fruitkha-contact" >
                                                           ...
                                                           Enter Category
                                                            <br/>
                                                            <input type="text" placeholder="Category" name="t1" style="width: 100%" >
							</p>  
                            ...
                            <div class="col-lg-6 mb-5 mb-lg-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="add_cate.php?del=<?php echo $r_gal[0] ?>"><span style="color: red" class="fa fa-trash"></span></a></td>
