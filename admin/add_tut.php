...
?>
                    ...
                    if(isset($_POST['b1']))
 {
   ...
   $t2=$_POST['t2'];
    ...
    $ins=mysqli_query($dbcon,"insert into tut values('','$t1','$t2','$t3','$nfn','0')");
    
    if($ins>0)
    {
      
                header("location:add_tut.php?suss=1");
            }
    }
						...
						<form method="POST"enctype="multipart/form-data" id="fruitkha-contact" >
							<p>
                                                        ...
                                                        <p>
                                                             Youtube Link
                                                            <br/>
                                                            <input type="text" placeholder="Copy youtube embed code here" name="t2" style="width: 100%">
								
                                                        </p>
                                                        <p>
                                                           Description
                                                            <br/>  
                                                            <textarea name="t3"id="editor"   placeholder="Description"></textarea></p>
							<br/>
                                                        <script>
	initSample();
</script>
