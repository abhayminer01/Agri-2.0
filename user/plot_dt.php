...
<?php
                    ...
                    if(isset($_POST['b1']))
 {
   ...
   $t2=$_POST['t2'];
    ...
    $ins=mysqli_query($dbcon,"insert into plot_msg values('','$mid','$t1','$t2','$t3','$t4','$usr','$r[6]','$date','0')");
                    ...
                    <div class="row">
                        <div class="col-lg-12">
							...
							<p>
                                                            ...
                                                            <input  type="email" placeholder="Email" name="t3" style="width: 100%" required=""onkeyup="vem(this.value)" /><span id="em"></span>
                                                                
                                                               
							</p>
                                                        <p><textarea name="t4"  cols="2"rows="2" placeholder="About Plot"></textarea></p>
							<br/>
